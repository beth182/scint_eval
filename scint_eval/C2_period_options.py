...
plt.scatter(obs_time12, obs_vals12, label='BCT_IMU', marker='.')
plt.scatter(obs_time15, obs_vals15, label='SCT_SWT', marker='.')

plt.plot(mod_time_12,mod_vals_12, label='UKV IMU')
plt.plot(mod_time_15,mod_vals_15, label='UKV SWT')
